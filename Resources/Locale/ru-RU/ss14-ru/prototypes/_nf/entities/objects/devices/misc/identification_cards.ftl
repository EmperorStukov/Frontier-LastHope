...
ent-CadetIDCard = ID карта кадета дсбф
    .desc = { ent-IDCardStandard.desc }
ent-DeputyIDCard = ID карта констебля дсбф
    .desc = { ent-CadetIDCard.desc }
ent-BrigmedicNFIDCard = ID карта дежурного врача дсбф
    .desc = { ent-CadetIDCard.desc }
...
ent-DetectiveNFIDCard = ID карта детектива дсбф
    .desc = { ent-CadetIDCard.desc }
ent-SecurityGuardIDCard = ID карта охранника
...
ent-PirateCaptainNFIDCard = ID карта лорда пиратов
    .desc = Йаррр, блестяще!
ent-PirateFirstMateNFIDCard = ID карта первого помощника
